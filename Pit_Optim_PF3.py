...
with col1:
    # Explication de l'algorithme Pseudo Flow
    with st.expander("À propos de l'algorithme Pseudo Flow", expanded=False):
        st.markdown("""
        <div class="explanation-box">
            <h3>Algorithme de Pseudo Flow</h3>
            <p>L'algorithme Pseudo Flow est une méthode moderne d'optimisation de fosse minière qui utilise la théorie des graphes et le concept de flot maximum.</p>
            
            <h4>Principes fondamentaux</h4>
            <ul>
                <li><strong>Modélisation par graphe</strong> : Le modèle de blocs est transformé en un graphe orienté où chaque bloc est un nœud.</li>
                <li><strong>Flot maximum</strong> : L'algorithme calcule le flot maximum entre une source (surface) et un puits (blocs profonds).</li>
                <li><strong>Coupe minimale</strong> : La coupe minimale du graphe correspond à la limite optimale de la fosse.</li>
            </ul>
            
            <h4>Avantages par rapport aux méthodes traditionnelles</h4>
            <ul>
                <li><strong>Rapidité</strong> : Généralement 3 à 10 fois plus rapide que Lerchs-Grossmann pour les grands modèles.</li>
                <li><strong>Précision</strong> : Résultats mathématiquement exacts dans le cadre du modèle.</li>
                <li><strong>Flexibilité</strong> : Gestion efficace des contraintes géotechniques complexes.</li>
            </ul>
            
            <h4>Paramètres clés</h4>
            <ul>
                <li><strong>Alpha</strong> : Contrôle la sensibilité de l'algorithme aux valeurs négatives. Une valeur plus faible inclut plus de blocs.</li>
                <li><strong>Méthode de calcul</strong> : Différentes approches pour résoudre le problème de flot maximum.</li>
                <li><strong>Capacity Scaling</strong> : Technique d'optimisation qui améliore les performances sur les grands modèles.</li>
            </ul>
            
            <p>L'algorithme a été développé par Hochbaum (2001) et a été largement adopté dans l'industrie minière pour sa performance et sa fiabilité.</p>
        </div>
        """, unsafe_allow_html=True)
